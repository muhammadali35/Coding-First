...
import blog1 from '../../assets/images/project_5.png'
          ...
          <div className="blog-content p-6">
            <div className="blog-date mb-2">
              <ul className="flex items-center space-x-2 text-gray-500 text-sm">
                ...
                <li>|</li>
                <li>
                  <a href="/" className="text-[#C32735] hover:underline">{post.category}</a>
                </li>
              </ul>
            </div>
            ...
            <div className="blog-bottom-text-link">
              <a href="/" className="text-[#C32735] hover:underline">+ Read More</a>
            </div>
          </div>
        </div>
      </div>
